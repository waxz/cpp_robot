...
namespace dds_helper{
    ...
    using DdsReaderVariant = absl::variant<
            DdsSimpleReader<Message::Laserscan1500,Message::Laserscan1500PubSubType>,
            DdsSimpleReader<Message::Pointcloud1200x800x4,Message::Pointcloud1200x800x4PubSubType>,
            DdsSimpleReader<Message::Pointcloud1920x1080x3,Message::Pointcloud1920x1080x3PubSubType>

    >;
    using DdsWriterVariant = absl::variant<
            DdsSimpleWriter<Message::Laserscan1500,Message::Laserscan1500PubSubType>,
            DdsSimpleWriter<Message::Pointcloud1200x800x4,Message::Pointcloud1200x800x4PubSubType>,
            DdsSimpleWriter<Message::Pointcloud1920x1080x3,Message::Pointcloud1920x1080x3PubSubType>
    >;
    using DdsReaderVariantBuilder = generic::TypeRegistry<
            DdsReaderVariant, ta_cfg_t* ,
            const  std::shared_ptr<DdsSimpleParticipant>&, const char*, const char*, const char*, const char*

    >;

    using DdsWriterVariantBuilder = generic::TypeRegistry<
            DdsWriterVariant,
            const  std::shared_ptr<DdsSimpleParticipant>&, const char*, const char*, const char*, const char*
...
//        DdsWriterVariantBuilder writer_builder_;
        ...
        std::unordered_map<std::string, std::function<DdsReaderVariant( ta_cfg_t* ,
                const  std::shared_ptr<DdsSimpleParticipant>&, const ReaderConfig&)>> reader_builder_functions;
